<script>
	...
	onMount(async () => {
		let response = await fetch('http://192.168.0.74:8080/playlistcheck')
		...
		if (playlist_present) {
			let response2 = await fetch('http://192.168.0.74:8080/allplaylists')
	...
	async function getAllPlaylists() {
		let response3 = await fetch('http://192.168.0.74:8080/allplaylists')
	...
	async function addEmptyPlaylist() {
		let URL = 'http://192.168.0.74:8080/createemptyplaylist/' + name;
	...
	async function addRandomPlaylist() {
		let url = 'http://192.168.0.74:8080/createrandomplaylist/' + randomname + '/' + count;
		let URL = encodeURI(url);
		try {
			const response = await fetch(URL)
				.then((response) => response.json())
	...
	async function deletePlaylist(rusicidd) {
		let url = 'http://192.168.0.74:8080/deleteplaylist/' + rusicidd;
		let URL = encodeURI(url);
		try {
			const response = await fetch(URL)
				.then((response) => response.json())
	...
	async function playPlaylist(rusicid) {
		let url = 'http://192.168.0.74:8080/playplaylist/' + rusicid;
		let URL = encodeURI(url);
		try {
			const response = await fetch(URL)
				.then((response) => response.json())
